...
//        Racun na: Ime i prezime  -  broj racuna
        ...
        Racun posiljalac = new Racun("83921-13123-4123", 5000);

        posiljalac.setImeIPrezime("Pera Peric");

        Racun primalac = new Racun("321332-3213-4214", 1000);

        primalac.setImeIPrezime("Zika Zikic");
