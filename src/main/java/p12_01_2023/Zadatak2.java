...
//        Dana (dan.mesec.godina.)god sklopljen je ugovor izmedju (print prodavca) i (print kupca) o kupovini nekretnine (adresa) po ceni od (cena nekretnin) pri cemu je kupac u obavezi da agenciji isplati novcanu vrednost u iznosu od (zarada agencije)
        ...
        FizickoLice prodavac = new FizickoLice("Pera Peric", "00004451",
                                                 "151567864");
        FizickoLice kupac = new FizickoLice("Mika Mikic", "0001545",
                                                "12345256");
        kupac.setJeKupovala(true);

        Ugovor ugovor = new Ugovor("12.12.2012", prodavac, kupac);
        ugovor.setCenaNekretnine(43000.0);
        ugovor.setAdresaNekretnine("Ulica 313, Nis");
